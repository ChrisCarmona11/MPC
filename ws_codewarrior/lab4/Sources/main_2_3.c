...
//					registro[9]);
		...
		//Por alguna razón usando el breakpoint la última posición del array 
		//se escribe bien pero al printearlo hace referencia al valor previo
		//a la asignación de la iteración de la última posición. Lo que indica
		//que está bien pero ese error se da por alguna razon desconocida.
		}
	}
